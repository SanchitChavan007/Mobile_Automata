...
public class MenuManager implements ActionListener {
	...
	public void createDefaultActions() {
		...
		JMenu fileMenu = addMenu(menuBar,"core.file", "Simulation", 'F', "File Menu Actions");
		fileMenu.addSeparator();
		createMenuItem(fileMenu, "Start", 'x', "Exit the application", new ExitAction(application));
		createMenuItem(fileMenu, "Stop", 'x', "Start Simulation", new ExitAction(application));
		createMenuItem(fileMenu, "Exit", 'x', "Stop Simulation", new ExitAction(application));


		JMenu editMenu = addMenu(menuBar, "core.edit", "Select Rule", 'E', "Edit Menu Actions");
		...
		JMenu windowMenu = addMenu(menuBar, "core.window", "Set Time", 'W', "PanelWindow Menu Actions");
